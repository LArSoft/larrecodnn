...
namespace ng {
  ...
  std::vector<std::string> static const EDepColumns{"run",
                                                    "subrun",
                                                    "event",
                                                    "ch_id",
                                                    "g4_id",
  ...
  EDepTable::EDepTable(std::string const& chargeHitLabel, std::vector<Row> const& data)
